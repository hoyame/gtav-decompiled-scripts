...
void __EntryFunction__()
{
	...
	func_398();
	func_384();
	uLocal_264 = ADD_SCENARIO_BLOCKING_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_383(27, 0);
	if (func_382())
	{
		func_381(409.6954f, -1567.046f, 28.2916f, 138.7093f, 1, 0);
	}
	N_0XC6ED9D5092438D91(0);
	while (true)
	{
		REPLAY_CHECK_FOR_EVENT_THIS_FRAME("M_STS", 0);
		if (func_380(()()))
		{
			func_373();
			func_370();
	...
	switch (iLocal_41)
	{
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_150, GET_ENTITY_COORDS(()(), 1)))
				{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		...
		if (func_7(*uParam0))
		{
			if (IS_ENTITY_A_MISSION_ENTITY(*uParam0) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(*uParam0, 1))
			{
				if (func_6(()()))
				{
					if (IS_PED_IN_VEHICLE(()(), *uParam0, 0))
					{
...
void func_15(int iParam0)
{
	...
	if (Global_113648.f_9087 || func_30(0))
	{
		...
		unk_0xB0C9A0F9AAEB7F0(&(Global_91433[iVar0 /*5*/].f_1), 5);
...
void func_21()
{
	...
	else if (!IS_PLAYER_PLAYING(()()))
	{
		...
		Global_100716 = 0;
		unk_0xB0C9A0F9AAEB7F0(&(Global_100681.f_20), 25);
	}
}
...
void func_23()
{
	...
	{
		if (func_27(Global_113648.f_2365.f_539.f_4321) != GET_ENTITY_MODEL(()()))
		{
			iVar0 = func_26(()());
...
void func_35()
{
	...
	switch (iLocal_41)
	{
		case 0:
			...
			{
				if (N_0X1E5185B72EF5158A("FHPRA_STOP"))
				{
					iLocal_285 = 0;
					iLocal_468 = 0;
					iLocal_41 = 1;
					N_0X706D57B0F50DA710("FHPRA_STOP");
				}
			}
			break;
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				if (func_12(&uLocal_150, GET_ENTITY_COORDS(()(), 1)))
				{
			...
			{
				REPLAY_RECORD_BACK_FOR_TIME(5f, 6f, 4);
				func_55();
				func_50();
			}
			break;
		...
		case 3:
			...
			{
				if (!IS_PED_IN_VEHICLE(()(), Local_290.f_0, 0))
				{
					SET_PED_INTO_VEHICLE(()(), Local_290.f_0, -1);
				}
				else
				{
...
void func_38(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_37 != 0 && iLocal_37 != joaat("object")) && iLocal_37 != joaat("gadget_parachute"))
		{
			if (func_6(()()))
			{
				if (HAS_PED_GOT_WEAPON(()(), iLocal_37, 0))
				{
					SET_CURRENT_PED_WEAPON(()(), iLocal_37, 0);
				}
			}
		}
	}
...
void func_39(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
		SPECIAL_ABILITY_DEACTIVATE_FAST(()(), 0);
		SET_ALL_RANDOM_PEDS_FLEE(()(), 1);
		SET_POLICE_IGNORE_PLAYER(()(), 1);
		func_48(1);
		THEFEED_FLUSH_QUEUE();
		THEFEED_PAUSE();
		if (Global_20383.f_1 > 3 && !bParam6)
		{
			if (N_0X7497D2CE2C30D24C())
			{
	...
	else
	{
		...
		{
			if ((((((!IS_PED_INJURED(()()) && !func_44(()())) && !func_41(()(), 0)) && !func_40()) && !bParam4) && !bParam5) && !NETWORK_IS_IN_SPECTATOR_MODE())
			{
				SET_ENTITY_INVINCIBLE(()(), 0);
			}
		}
		else if (((!IS_PED_INJURED(()()) && !func_44(()())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(()(), 0);
		}
		Global_78556 = 0;
...
bool func_40()
{
	return BitTest(Global_1853910[()() /*862*/].f_36.f_18, 14);
}
...
int func_46(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	if (IS_PC_VERSION())
	{
		if (N_0XA0FE76168A189DDB() != iParam0 && uParam2)
		{
			N_0X20746F7B1032A3C7(iParam0, uParam1, 1, iParam3);
			iVar0 = 1;
		}
	}
	return iVar0;
...
void func_48(int iParam0)
{
	if (iParam0 == 1)
	{
		unk_0xB0C9A0F9AAEB7F0(&Global_8253, 13);
	}
	else
	{
		CLEAR_BIT(&Global_8253, 13);
	}
}
...
int func_49(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)
{
	...
	if (func_6(iParam0))
	{
		...
		{
			fVar1 = 0f;
			bVar0 = GET_GROUND_Z_FOR_3D_COORD(Param1, &fVar1, 0, 0);
			if (bVar0)
			{
				Param1.f_2 = fVar1;
			}
		}
		SET_ENTITY_COORDS(iParam0, Param1, 1, 0, 0, iParam4);
...
void func_51(bool bParam0, int iParam1)
{
	...
	if (Global_113648.f_9087 || func_30(0))
	{
		...
		unk_0xB0C9A0F9AAEB7F0(&(Global_91433[iVar0 /*5*/].f_1), 4);
		unk_0xB0C9A0F9AAEB7F0(&Global_78807, true);
		Global_78823 = uVar2;
...
int func_58(int iParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	...
	if ((iParam3 == 1 || iParam3 == 2) || iParam3 == 3)
	{
		if (iParam4 == 0)
		{
			...
			if (!IS_ENTITY_AT_COORD(()(), Param1, fParam10, fParam10, 2f, 0, 1, 2))
			{
				IS_ENTITY_AT_COORD(()(), Param1, fParam10, fParam10, 2f, 1, 1, 2);
	...
	else if (IS_ENTITY_AT_COORD(iParam0, Param1, fParam10, fParam10, 2f, 0, 1, 2))
	{
		if (*iParam7 == -1)
		{
			unk_0xB74F181ADFC39BF(iParam0, 2);
			return 1;
		}
		if (!*iParam8)
		{
	...
	else
	{
		...
		{
			unk_0xB74F181ADFC39BF(iParam0, 1);
		}
		if (!*iParam6)
		{
...
int func_62(int iParam0, int iParam1)
{
	...
	iVar0 = GET_VEHICLE_PED_IS_IN(()(), 0);
	if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
	{
		if (GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == ()())
		{
			if (!IS_VEHICLE_STOPPED(iVar0))
			{
				BRING_VEHICLE_TO_HALT(iVar0, iParam0, iParam1, 0);
				return 0;
			}
		}
		else
...
{
	return vdist2(GET_ENTITY_COORDS(iParam0, iParam3), Param1) <= (fParam2 * fParam2);
}
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, Local_265, 0))
			{
				...
				{
					uLocal_271 = N_0XFCD5C8E06E502F5A(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
		...
		case 1:
			if (bParam1)
			{
				if (((func_82(2, Local_290.f_1, Local_290.f_4) && func_82(4, Local_265, 0)) && func_82(3, Local_265, 0)) && func_82(5, Local_265, 0))
				{
					func_74(()(), 408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_72();
...
void func_72()
{
	...
	iLocal_467 = 1;
	func_383(27, 0);
	DOOR_SYSTEM_SET_DOOR_STATE(Global_41953[13 /*31*/], 4, 1, 0);
	iLocal_468 = 0;
}
...
void func_75()
{
	...
	func_76(&uLocal_294, iVar0, ()(), sVar1, 0, 1);
	...
	while (iVar0 <= 2)
	{
		...
		if (!func_78(Local_289[iVar0 /*22*/], joaat("script_task_start_scenario_at_position")))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					TASK_START_SCENARIO_AT_POSITION(Local_289[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					unk_0x974B2530CABDF56(Local_289[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		GIVE_WEAPON_TO_PED(Local_289[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_289[iVar0 /*22*/], uLocal_292);
...
int func_82(int iParam0, struct<3> Param1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				SET_ENTITY_AS_MISSION_ENTITY(Global_97178[0], 1, 1);
				...
				if (func_7(Local_290.f_0))
				{
					...
					SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_290.f_0, 2, 0);
					SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_290.f_0, 3, 0);
					func_89(Local_290.f_0, 0);
					SET_VEHICLE_HAS_STRONG_AXLES(Local_290.f_0, 1);
					unk_0xB74F181ADFC39BF(Local_290.f_0, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (DOES_ENTITY_EXIST(Global_97178.f_9[iVar0]))
				{
					if (!IS_PED_DEAD_OR_DYING(Global_97178.f_9[iVar0], 1))
					{
						SET_ENTITY_AS_MISSION_ENTITY(Global_97178.f_9[iVar0], 1, 1);
						Local_289[iVar0 /*22*/] = Global_97178.f_9[iVar0];
						if (func_380(Local_289[iVar0 /*22*/]))
						{
							SET_PED_TARGET_LOSS_RESPONSE(Local_289[iVar0 /*22*/], 2);
							N_0X9D64D7405520E3D3(Local_289[iVar0 /*22*/], 1);
							func_87(iVar0);
							iVar1++;
						}
					}
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				...
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_97178[iVar3], 1, 1);
		...
		case 5:
			if (func_83(&uLocal_262, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_290.f_0))
				{
					ATTACH_ENTITY_TO_ENTITY(uLocal_262, Local_290.f_0, 0, 0f, -1.85f, 0.05f, GET_ENTITY_ROTATION(Local_290.f_0, 2), 0, 0, 0, 0, 2, 1, 0);
					if (IS_ENTITY_ATTACHED_TO_ENTITY(Local_290.f_0, uLocal_262))
					{
						return 1;
					}
				}
...
int func_83(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	if (!DOES_ENTITY_EXIST(*uParam0))
	{
		...
		{
			*uParam0 = CREATE_OBJECT(iParam1, Param2, 1, 1, 0);
			if (DOES_ENTITY_EXIST(*uParam0))
			{
...
int func_86(var uParam0, var uParam1, struct<3> Param2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	if (!DOES_ENTITY_EXIST(*uParam0))
	{
		...
		{
			*uParam0 = CREATE_PED(26, uParam1, Param2, uParam3, 1, 1);
			if (func_380(*uParam0))
			{
				if (bParam5)
				{
...
int func_88(int iParam0, var uParam1, struct<3> Param2, float fParam3, bool bParam4)
{
	if (!DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_85(uParam1, "Loading", 0))
		{
			*iParam0 = CREATE_VEHICLE(uParam1, Param2, uParam3, 1, 1, 0);
			if (DOES_ENTITY_EXIST(*iParam0))
			{
	...
	else
	{
		if (func_7(*iParam0))
		{
			SET_ENTITY_COORDS(*iParam0, Param2, 1, 0, 0, 1);
...
void func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, int iParam6, bool bParam7, int iParam8)
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!IS_PED_IN_VEHICLE(()(), *iParam0, 0) && !func_97(*iParam0)) && !func_96(*iParam0))
				{
					func_34(iParam4);
					if (!IS_ENTITY_AT_COORD(*iParam0, Param5, iParam8, iParam8, 2f, 0, 1, 2))
					{
		...
		if (IS_PED_IN_ANY_VEHICLE(()(), 0))
		{
			...
			if (iVar0 != *uParam0)
			{
				if (func_7(iVar0))
				{
					...
					{
						uVar2 = GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(()(), 0));
						if (func_6(uVar2))
						{
...
int func_96(int iParam0)
{
	...
	if ((func_380(()()) && IS_PED_IN_ANY_VEHICLE(()(), 0)) && func_7(iParam0))
	{
...
void func_98()
{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, bLocal_28))
			{
				if (N_0X1E5185B72EF5158A("FHPRA_VAN"))
				{
					if (GET_PLAYER_WANTED_LEVEL(()()) == 0)
					{
						if (iLocal_42 == 1 || iLocal_42 == 2)
						{
							...
							REPLAY_RECORD_BACK_FOR_TIME(5f, 6f, 4);
							N_0X706D57B0F50DA710("FHPRA_VAN");
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				...
				if (!iLocal_469)
				{
					N_0XDFEBD56D9BD1EB16("SCRIPTED_SCANNER_REPORT_BS_PREP_A_01", 0f);
					iLocal_469 = 1;
				}
			}
	...
	if ((iParam4 == 1 || iParam4 == 2) || iParam4 == 3)
	{
		if (iParam3 == 0)
		{
			...
			if (!bParam8)
			{
				if (func_7(iParam0))
				{
					if (IS_ENTITY_AT_COORD(iParam0, Param1, fParam9, fParam9, 2f, 1, 1, 0))
					{
						return 1;
					}
				}
			}
			else if (IS_ENTITY_AT_COORD(()(), Param1, fParam9, fParam9, 2f, 1, 1, 2))
			{
				return 1;
			}
			if (func_66(func_60(func_69()), 0, 0))
	...
	while (iVar0 < 3)
	{
		...
		if (!IS_PED_INJURED(iVar1))
		{
			switch (iLocal_44[iVar0])
			{
				...
				case 1:
					if (func_109(iVar0, iVar1) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
					{
						iLocal_44[iVar0] = 0;
						func_108(iVar1);
					}
				...
				case 2:
					if (func_107(iVar0, iVar1) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
					{
						iLocal_44[iVar0] = 0;
						func_108(iVar1);
					}
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_266, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_43[iParam0] = 3;
			break;
		
		case 3:
			if (!func_111(iParam0, iParam1) || func_63(()(), Local_266, 2f, 1))
			{
				iLocal_43[iParam0] = 4;
			}
			break;
...
int func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!IS_POSITION_OCCUPIED(Local_254[iLocal_470 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_254[iLocal_470 /*4*/], fVar0, 20000, 0.25f, 0, Local_254[iLocal_470 /*4*/].f_3);
				iLocal_43[iParam0] = 1;
			}
			break;
...
int func_110(int iParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		if (BitTest(Global_96534, bVar0))
		{
			...
			unk_0xB0C9A0F9AAEB7F0(&Global_96535, bVar0);
			return 1;
		}
	}
	return 0;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((DOES_ENTITY_EXIST(Local_290.f_0) && IS_VEHICLE_DRIVEABLE(Local_290.f_0, 0)) && !IS_ENTITY_AT_COORD(Local_290.f_0, Local_266, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!IS_PED_INJURED(()()) && IS_PED_IN_VEHICLE(()(), Local_290.f_0, 0)) && GET_PLAYER_WANTED_LEVEL(()()) == 0)
			{
				if (IS_PED_IN_VEHICLE(iParam1, Local_290.f_0, 0) && GET_PED_IN_VEHICLE_SEAT(Local_290.f_0, -1, 0) == iParam1)
				{
					iLocal_44[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if (IS_ENTITY_IN_ANGLED_AREA(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(()(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, 1, 0))
		{
			iLocal_470 = 0;
			iLocal_44[iParam0] = 1;
			return 1;
		}
		else if (IS_ENTITY_IN_ANGLED_AREA(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(()(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, 1, 0))
		{
			iLocal_470 = 1;
			iLocal_44[iParam0] = 1;
			return 1;
...
void func_118()
{
	...
	if (!bLocal_28)
	{
		if (GET_PLAYER_WANTED_LEVEL(()()) >= 1)
		{
			bLocal_274 = true;
		}
		else
		{
			SUPPRESS_CRIME_THIS_FRAME(()(), 38);
			SUPPRESS_CRIME_THIS_FRAME(()(), 30);
			bLocal_274 = false;
		}
		if (iLocal_40 == 2)
		{
			if (!iLocal_286)
			{
				if (!func_63(()(), Local_290.f_1, 180f, 1))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
...
void func_119()
{
	...
	else
	{
		...
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_289[iVar0 /*22*/], ()(), 1))
			{
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_289[iVar0 /*22*/]);
				if (((IS_PED_CURRENT_WEAPON_SILENCED(()()) || IS_PED_BEING_STEALTH_KILLED(Local_289[iVar0 /*22*/])) || WAS_PED_KILLED_BY_STEALTH(Local_289[iVar0 /*22*/])) || WAS_PED_KILLED_BY_TAKEDOWN(Local_289[iVar0 /*22*/]))
				{
					if (!bLocal_274)
					{
						SUPPRESS_CRIME_THIS_FRAME(()(), 41);
						SUPPRESS_CRIME_THIS_FRAME(()(), 33);
			...
			if (func_149(iParam0) && func_63(Local_289[iParam0 /*22*/], Local_289[iParam0 /*22*/].f_1, 3f, 1))
			{
				if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_78(Local_289[iParam0 /*22*/], joaat("script_task_turn_ped_to_face_entity")))
					{
						...
						unk_0xE95B96CFEFE7B61(Local_289[iParam0 /*22*/], ()(), 0);
					}
		...
		case 7:
			if ((GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_274 && func_124(iParam0, 15))
				{
					func_73();
					func_134(iParam0);
					REMOVE_COP_BLIP_FROM_PED(Local_289[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_465 != -1)
					{
						...
						else if ((IS_PED_SHOOTING(()()) || IS_PED_CLIMBING(()())) || IS_PED_IN_MELEE_COMBAT(()()))
						{
							func_123(2);
						}
						else if (GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(()(), &iVar1))
						{
							if (unk_0x101C509A6E67F99(iVar1))
							{
					...
					if ((func_78(Local_289[iParam0 /*22*/], joaat("script_task_invalid")) || func_78(Local_289[iParam0 /*22*/], joaat("script_task_stand_still"))) && GET_PLAYER_WANTED_LEVEL(()()) < 2)
					{
						if (!func_78(Local_289[iParam0 /*22*/], joaat("script_task_arrest_ped")))
						{
							TASK_ARREST_PED(Local_289[iParam0 /*22*/], ()());
						}
					}
				}
			}
...
void func_121(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	unk_0xB0C9A0F9AAEB7F0(&Global_20591, false);
...
void func_123(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		SET_PLAYER_WANTED_LEVEL(()(), iParam0, 0);
		SET_PLAYER_WANTED_LEVEL_NOW(()(), 0);
	}
}
...
void func_127(int iParam0)
{
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_380(Local_289[iParam0 /*22*/]))
		{
			if (func_78(Local_289[iParam0 /*22*/], joaat("script_task_perform_sequence")) || IS_PED_RUNNING_MOBILE_PHONE_TASK(Local_289[iParam0 /*22*/]))
			{
			...
			SET_PED_AS_COP(Local_289[iParam0 /*22*/], 1);
			TASK_ARREST_PED(Local_289[iParam0 /*22*/], ()());
			GIVE_WEAPON_TO_PED(Local_289[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
...
void func_128(int iParam0)
{
	...
	if ((iLocal_40 != 2 && !iLocal_464) && !IS_ENTITY_DEAD(Local_289[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_289[iParam0 /*22*/], 30f))
		{
			...
			else if (!func_124(iParam0, 15) || IS_ENTITY_IN_ANGLED_AREA(()(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_129();
				iLocal_461 = 0;
				if (iParam0 == 2)
				...
				{
					N_0X3523634255FC3318(Local_289[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_464 = 1;
			}
		}
...
int func_131(int iParam0, float fParam1)
{
	...
	if (func_380(()()) && func_380(iParam0))
	{
		if (func_132(()(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
void func_134(int iParam0)
{
	...
	{
		CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_289[iParam0 /*22*/], uLocal_292);
		if (iParam0 == 2)
		{
			OPEN_SEQUENCE_TASK(&uVar0);
			if (!func_63(Local_289[iParam0 /*22*/], Local_289[iParam0 /*22*/].f_1, 3f, 1))
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_289[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_289[iParam0 /*22*/].f_4);
			}
			else
			{
			...
			{
				unk_0x974B2530CABDF56(0, 1, 1);
			}
			CLOSE_SEQUENCE_TASK(uVar0);
			TASK_PERFORM_SEQUENCE(Local_289[iParam0 /*22*/], uVar0);
...
void func_135()
{
	if (func_12(&uLocal_46, GET_ENTITY_COORDS(()(), 1)))
	{
		if (!func_103())
		{
...
void func_151(int iParam0)
{
	switch (Local_289[iParam0 /*22*/].f_21)
	{
		case 0:
			...
			{
				if (iLocal_459[2] && !N_0X049E937F18F4020C(Local_289[iParam0 /*22*/]))
				{
					CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
					TASK_START_SCENARIO_IN_PLACE(Local_289[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(Local_289[iParam0 /*22*/], 1), 100f))
		{
			...
			else if (!bLocal_274)
			{
				SUPPRESS_CRIME_THIS_FRAME(()(), 41);
				SUPPRESS_CRIME_THIS_FRAME(()(), 33);
				SUPPRESS_CRIME_THIS_FRAME(()(), 12);
				SET_PLAYER_WANTED_LEVEL(()(), 0, 0);
				SET_PLAYER_WANTED_LEVEL_NOW(()(), 0);
			}
		}
	}
	else if (func_153(Local_289[iParam0 /*22*/], ()(), 5f, 1))
	{
		if (!bLocal_274)
		{
			SUPPRESS_CRIME_THIS_FRAME(()(), 41);
...
int func_154(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_6(()()) && func_6(iParam0))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, ()(), 1))
		{
			return 1;
		}
		...
		if (!IS_PED_ARMED(()(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(()()))
			{
				Var0 = { GET_ENTITY_COORDS(()(), 1) - GET_ENTITY_COORDS(iParam0, 1) };
				if ((((Var0.f_0 * Var0.f_0) + (Var0.f_1 * Var0.f_1)) + (Var0.f_2 * Var0.f_2)) <= 5f)
				{
					return func_167(()(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_155(int iParam0, float fParam1)
{
	...
	if (func_6(()()) && func_6(iParam0))
	{
		if (func_166(iParam0) || IS_PLAYER_TARGETTING_ENTITY(()(), iParam0))
		{
			if (IS_PED_ARMED(()(), 6))
			{
				fVar0 = 40f;
			...
			if (IS_ENTITY_AT_ENTITY(()(), iParam0, fVar0, fVar0, fVar0, 0, 1, 0))
			{
...
{
	return func_157(iParam0, ()(), fParam1, 1, 250, 7);
}
...
int func_158(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	...
	iVar4 = unk_0xE7DD1EBCA8D2DE3(*uParam0, &uVar0, &Var1, &uVar2, &iVar3);
	if (iVar4 == 0)
	{
		*uParam0 = 0;
		return 0;
	...
	*uParam0 = 0;
	if (unk_0x101C509A6E67F99(iVar3))
	{
		func_6(iVar3);
		if (GET_PED_INDEX_FROM_ENTITY_INDEX(iVar3) == iParam2)
		{
			if (bLocal_39)
			{
				DRAW_DEBUG_LINE_WITH_TWO_COLOURS(Param1, GET_ENTITY_COORDS(iParam2, 1), 255, 0, 0, 255, 0, 0, 255, 255);
			}
	...
	if (IS_ENTITY_A_VEHICLE(iVar3))
	{
		...
		{
			if (GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iVar3) == GET_VEHICLE_PED_IS_IN(iParam2, 0))
			{
				if (bLocal_39)
				{
					DRAW_DEBUG_LINE_WITH_TWO_COLOURS(Param1, GET_ENTITY_COORDS(iParam2, 1), 255, 0, 0, 255, 0, 0, 255, 255);
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_163(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
...
{
	if (IS_PLAYER_FREE_AIMING_AT_ENTITY(()(), iParam0) && IS_PED_ARMED(()(), 6))
	{
		return 1;
	}
	return 0;
...
bool func_167(int iParam0, int iParam1, float fParam2)
{
	...
	Var1 = { GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1) };
...
int func_168(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_6(()()) && func_6(iParam0))
	{
		GET_CURRENT_PED_WEAPON(()(), &iVar2, 1);
...
int func_169(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (((IS_PROJECTILE_TYPE_WITHIN_DISTANCE(GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_grenade"), fParam1, 1) || IS_PROJECTILE_TYPE_WITHIN_DISTANCE(GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_molotov"), fParam1, 1)) || IS_PROJECTILE_TYPE_WITHIN_DISTANCE(GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_smokegrenade"), fParam1, 1)) || IS_PROJECTILE_TYPE_WITHIN_DISTANCE(GET_ENTITY_COORDS(iParam0, 1), joaat("weapon_stickybomb"), 5f, 1))
		{
			if (bParam3)
			{
	...
	else
	{
		...
		if (IS_PROJECTILE_IN_AREA(Var0, Var1, 1))
		{
			return 1;
		}
	}
...
int func_170(int iParam0, float fParam1)
{
	...
	if ((((GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(iParam0, joaat("weapon_grenade"), fParam1, &Var1, &uVar0, 0) || GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(iParam0, joaat("weapon_smokegrenade"), fParam1, &Var1, &uVar0, 0)) || GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(iParam0, joaat("weapon_bzgas"), fParam1, &Var1, &uVar0, 0)) || GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(iParam0, joaat("weapon_stickybomb"), fParam1, &Var1, &uVar0, 0)) || GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(iParam0, joaat("weapon_molotov"), fParam1, &Var1, &uVar0, 0))
	{
...
int func_171(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_163(Param1 - GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_172(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(()()))
		{
			if (IS_ENTITY_AT_ENTITY(()(), iParam0, fParam3, fParam3, fParam3, 0, 1, 0))
			{
				return 1;
			}
		}
...
{
	if (IS_ENTITY_AT_COORD(()(), unk_0xD1381B6E0F3987D(Local_289[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !IS_PED_ARMED(()(), 6))
	{
		return 1;
	}
	return 0;
		...
		else if (iParam1 == 5)
		{
			if (Local_289[func_150(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					N_0X3523634255FC3318(Local_289[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
	...
	if (!func_149(iParam0) || iParam2)
	{
		...
		else if (iParam1 == 5)
		{
			if (Local_289[iParam0 /*22*/].f_19 != 5)
			{
				...
				N_0X3523634255FC3318(Local_289[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_272)
		{
			if (!BitTest(Local_289[iParam0 /*22*/].f_15, 12))
			{
				unk_0xB0C9A0F9AAEB7F0(&(Local_289[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
...
void func_184(int iParam0)
{
	...
	{
		fVar0 = GET_PLAYER_CURRENT_STEALTH_NOISE(()());
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_282)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(()(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					if (IS_PED_FALLING(()()) || IS_PED_CLIMBING(()()))
					{
						iLocal_282 = 1;
					...
					{
						if ((((fVar0 > 16f && !Local_289[iParam0 /*22*/].f_16) && !BitTest(Local_289[iParam0 /*22*/].f_15, 10)) && !IS_ENTITY_IN_ANGLED_AREA(()(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((IS_ENTITY_IN_ANGLED_AREA(()(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0)) && !BitTest(Local_289[iParam0 /*22*/].f_15, 10)) && !BitTest(Local_289[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_289[iParam0 /*22*/].f_16) && !IS_ENTITY_IN_ANGLED_AREA(()(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_186(iParam0, 11);
					}
				}
		...
		else if (IS_ENTITY_IN_ANGLED_AREA(()(), Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, 1, 0))
		{
...
void func_186(int iParam0, bool bParam1)
{
	if (!BitTest(Local_289[iParam0 /*22*/].f_15, bParam1))
	{
		unk_0xB0C9A0F9AAEB7F0(&(Local_289[iParam0 /*22*/].f_15), bParam1);
		Local_289[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_187(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_153(Local_289[iParam0 /*22*/], ()(), 5f, 1) && !IS_PED_BEING_STEALTH_KILLED(Local_289[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_STEALTH(Local_289[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_TAKEDOWN(Local_289[iParam0 /*22*/]))
		{
	...
	else if (!func_153(Local_289[iParam0 /*22*/], ()(), 5.5f, 1))
	{
		func_185(iParam0, 5);
		func_185(iParam0, 3);
	}
...
int func_188(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (IS_ENTITY_AT_COORD(()(), unk_0xD1381B6E0F3987D(Local_289[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (IS_ENTITY_TOUCHING_ENTITY(Local_289[iParam0 /*22*/], ()()))
	{
...
void func_190(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_289[iParam0 /*22*/].f_16)
			{
				if (!BitTest(Local_289[iParam0 /*22*/].f_15, 12))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(()(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, 1, 0))
					{
						iLocal_282 = 1;
						iLocal_281 = GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!IS_ENTITY_IN_ANGLED_AREA(()(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, 1, 0) || BitTest(Local_289[iParam0 /*22*/].f_15, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (IS_ENTITY_IN_ANGLED_AREA(()(), Local_255[3 /*7*/], Local_255[3 /*7*/].f_3, Local_255[3 /*7*/].f_6, 0, 1, 0))
	{
		func_193(iParam0, 3);
	}
	else
		...
		case 4:
			if (!IS_PED_IN_ANY_VEHICLE(()(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					if (!IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_255[4 /*7*/], Local_255[4 /*7*/].f_3, Local_255[4 /*7*/].f_6, 0, 1, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!BitTest(Local_289[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					unk_0xB0C9A0F9AAEB7F0(&(Local_289[iParam0 /*22*/].f_15), 9);
					func_186(iParam0, 8);
				}
				else
				{
...
{
	if (func_153(()(), Local_289[iParam0 /*22*/], 30f, 1))
	{
		if (func_157(Local_289[iParam0 /*22*/], ()(), 140f, 1, 250, 7))
		{
...
void func_195(int iParam0)
{
	...
	if (DOES_ENTITY_EXIST(iParam0->f_7))
	{
		if (!IS_ENTITY_DEAD(iParam0->f_7, 0))
		{
			...
			{
				SET_PED_HAS_AI_BLIP(iParam0->f_7, 0);
			}
		}
		bVar0 = true;
	}
	...
	if (!IS_PED_INJURED(iParam0))
	{
		if (!DOES_PED_HAVE_AI_BLIP(iParam0))
		{
			...
			if (bVar0)
			{
				if (iParam8 == -1)
				{
					SET_PED_HAS_AI_BLIP(iParam0, 1);
				}
				else
				{
					SET_PED_HAS_AI_BLIP_WITH_COLOUR(iParam0, 1, iParam8);
				}
				uParam1->f_7 = iParam0;
		...
		if (!iParam9 == -1)
		{
			SET_PED_AI_BLIP_SPRITE(iParam0, iParam9);
		}
		SET_PED_AI_BLIP_FORCED_ON(iParam0, iParam4);
		SET_PED_AI_BLIP_HAS_CONE(iParam0, iParam5);
		*uParam1 = GET_AI_PED_PED_BLIP_INDEX(iParam0);
		...
		if (!BitTest(uParam1->f_6, 2))
		{
			if (DOES_BLIP_EXIST(*uParam1))
			{
				unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_6), 2);
			}
		}
		if (IS_PED_IN_ANY_VEHICLE(iParam0, 0))
		{
			uParam1->f_1 = GET_AI_PED_VEHICLE_BLIP_INDEX(iParam0);
			if (!BitTest(uParam1->f_6, 3))
			{
				if (DOES_BLIP_EXIST(uParam1->f_1))
				{
					...
					unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_6), 3);
				}
			}
	...
	while (iVar0 <= 1)
	{
		...
		else
		{
			if (DOES_ENTITY_EXIST(Local_289[iVar0 /*22*/]))
			{
				...
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_289[iVar0 /*22*/], GET_PLAYERS_LAST_VEHICLE(), 1))
					{
						CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_289[iVar0 /*22*/]);
						func_125();
					}
...
void func_198(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_19)
	{
		case 1:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(()(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
				{
					func_127(iParam0);
					func_125();
					return;
		...
		case 5:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (!func_153(Local_289[iParam0 /*22*/], ()(), 1.5f, 1))
				{
		...
		case 7:
			if (GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				fVar1 = GET_PLAYER_CURRENT_STEALTH_NOISE(()());
...
void func_201(int iParam0)
{
	...
	if (!iLocal_466)
	{
		bVar0 = GET_PED_STEALTH_MOVEMENT(()());
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				if (!func_153(()(), Local_289[iParam0 /*22*/], 10f, 1))
				{
...
void func_202(int iParam0)
{
	...
	bVar0 = IS_PED_ARMED(()(), 4);
	if (Local_289[iParam0 /*22*/].f_20 != 6 && Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_153(()(), Local_289[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_289[iParam0 /*22*/].f_16)
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(Local_289[iParam0 /*22*/], 1), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_380(Local_289[iParam0 /*22*/]))
	{
		...
		if (IS_ENTITY_AT_ENTITY(()(), Local_289[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(()(), Local_289[iParam0 /*22*/]) || IS_PLAYER_TARGETTING_ENTITY(()(), Local_289[iParam0 /*22*/]))
			{
				if (Local_289[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_205()
{
	...
	{
		if ((((func_380(Local_289[0 /*22*/]) && func_380(Local_289[1 /*22*/])) && func_12(&uLocal_46, GET_ENTITY_COORDS(()(), 1))) && func_63(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f, 1)) && func_63(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f, 1))
		{
		...
		else if ((func_380(Local_289[2 /*22*/]) && func_12(&uLocal_98, GET_ENTITY_COORDS(()(), 1))) && func_63(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f, 1))
		{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, bLocal_28))
			{
				...
				N_0X706D57B0F50DA710("FHPRA_START");
				if (IS_DOOR_REGISTERED_WITH_SYSTEM(Global_41953[13 /*31*/]))
				{
					N_0X06C0023BED16DD6B(Global_41953[13 /*31*/], 1);
				}
				iLocal_479 = 0;
				REPLAY_RECORD_BACK_FOR_TIME(2f, 10f, 4);
				iLocal_41 = 1;
			}
			break;
		
		case 1:
			if (GET_PLAYER_WANTED_LEVEL(()()) < 3)
			{
				if (func_380(Local_289[2 /*22*/]))
				{
					if (IS_PED_IN_ANY_HELI(()()))
					{
						if (IS_ENTITY_IN_ANGLED_AREA(()(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) || IS_PED_SHOOTING(()()))
						{
							SET_PLAYER_WANTED_LEVEL(()(), 3, 0);
							SET_PLAYER_WANTED_LEVEL_NOW(()(), 0);
						}
					}
				}
			}
			if ((IS_PED_CLIMBING(()()) && iLocal_479 == 0) && func_132(Local_290.f_0, ()(), 1) < 100f)
			{
				REPLAY_RECORD_BACK_FOR_TIME(7f, 7f, 4);
				iLocal_479 = 1;
			}
			if (func_7(Local_290.f_0))
			{
				...
				{
					REPLAY_RECORD_BACK_FOR_TIME(10f, 6f, 4);
					iLocal_41 = 2;
				}
				if (bLocal_274)
				{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, 0))
			{
				...
				CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				CLEAR_AREA_OF_PEDS(Local_289[0 /*22*/].f_1, 5f, 0);
				if (func_275(()(), 12, 4) || func_275(()(), 12, 3))
				{
					bLocal_272 = true;
				}
				func_224();
...
void func_211(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	uVar0 = STREAMVOL_CREATE_SPHERE(Param0, fParam1, iParam2, 127);
	if (STREAMVOL_IS_VALID(uVar0))
	{
		iVar1 = (GET_GAME_TIMER() + iParam3);
		while (!STREAMVOL_HAS_LOADED(uVar0) && GET_GAME_TIMER() < iVar1)
		{
			if (bParam5)
			{
				func_213(0);
...
void func_213(int iParam0)
{
	...
	if (!Global_20383.f_1 == 1)
	{
		...
		unk_0xB0C9A0F9AAEB7F0(&Global_8254, 2);
	}
}
...
void func_214(int iParam0)
{
	...
	{
		unk_0xB0C9A0F9AAEB7F0(&Global_8254, 16);
	}
	if (N_0X7497D2CE2C30D24C())
	{
		unk_0xF15249D24BC5ADA(0);
	...
	if (iParam0 == 1)
	{
		unk_0xB0C9A0F9AAEB7F0(&Global_8253, 30);
	}
	else
	{
		CLEAR_BIT(&Global_8253, 30);
	}
	if (!func_47())
	{
		Global_20383.f_1 = 3;
...
void func_215(bool bParam0, bool bParam1)
{
	if (bParam0)
	{
		if (func_217(0))
		{
			...
			if (bParam1)
			{
				N_0X584FDFDA48805B86(&Global_20320);
			}
			Global_20311 = { Global_20329[Global_20328 /*3*/] };
			N_0X693A5C6D6734085B(Global_20311);
		}
	}
	else if (Global_20584 == 1)
	{
		...
		if (bParam1)
		{
			N_0X693A5C6D6734085B(Global_20320);
		}
		else
		{
			N_0X693A5C6D6734085B(Global_20311);
...
void func_220(int iParam0)
{
	if (iParam0 == 1)
	{
		unk_0xB0C9A0F9AAEB7F0(&(Global_100681.f_20), 13);
	}
	else
	{
...
{
	unk_0xB0C9A0F9AAEB7F0(&Global_96536, bParam0);
}
...
void func_224()
{
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_225(iVar0, GET_ENTITY_COORDS(iVar0, 1), GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_245(iParam0, 0, 0)) || func_245(iParam0, 1, 0)) || func_245(iParam0, 2, 0)) || func_268(iParam0) != 145) || func_244(iParam0)) || func_243(iParam0)) || func_242(iParam0)) || func_241(iParam0)) || !func_229(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_243(iParam0))
		{
		}
	...
	if (NETWORK_IS_SIGNED_IN())
	{
		if (NETWORK_HAS_VALID_ROS_CREDENTIALS())
		{
			if (NETWORK_HAS_ROS_PRIVILEGE_PLAYED_LAST_GEN())
			{
				...
				unk_0xB0C9A0F9AAEB7F0(&uVar0, 2);
				unk_0xB0C9A0F9AAEB7F0(&uVar0, 4);
				unk_0xB0C9A0F9AAEB7F0(&uVar0, 6);
				unk_0xB0C9A0F9AAEB7F0(&Global_25, 2);
				unk_0xB0C9A0F9AAEB7F0(&Global_25, 4);
				unk_0xB0C9A0F9AAEB7F0(&Global_25, 6);
				N_0XB3271D7AB655B441(joaat("sp_unlock_exclus_content"), uVar0, 1);
				if (ARE_PROFILE_SETTINGS_VALID())
				{
					uVar0 = GET_PROFILE_SETTING(866);
					unk_0xB0C9A0F9AAEB7F0(&uVar0, false);
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_12 = 0;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 20);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 7);
			iVar0 = 1;
			break;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.699f, 29.6552f };
			...
			uParam0->f_12 = 1;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 19);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 7);
			iVar0 = 1;
			break;
		...
		case 9:
			*uParam0 = { 1459.509f, -1380.45f, 78.3259f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 6);
			iVar0 = 1;
			break;
		...
		case 12:
			...
			*uParam0 = { -1652.004f, -3142.348f, 12.9921f };
			...
			uParam0->f_12 = 0;
			uParam0->f_13 = 359;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), false);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 21);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 14);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 7);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 10);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 12);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 28);
			iVar0 = 1;
			break;
		...
		case 15:
			...
			*uParam0 = { -846.27f, -1363.19f, 0.22f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 10);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 12);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 22);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 28);
			iVar0 = 1;
			break;
		...
		case 20:
			...
			*uParam0 = { 1769.3f, 3244f, 41.1f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 10);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 12);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 23);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 28);
			iVar0 = 1;
			break;
		...
		case 21:
			...
			*uParam0 = { 192.7897f, -1020.539f, -99.98f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 10);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 12);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 24);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 28);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 29);
			iVar0 = 1;
			break;
		...
		case 28:
			...
			*uParam0 = { 196.2794f, -1020.479f, -99.98f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 12);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 7);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 27);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 24);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 29);
			iVar0 = 1;
			break;
		...
		case 24:
			...
			*uParam0 = { 0f, 0f, 0f };
			...
			uParam0->f_4 = 0;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 10);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 11);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 13);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 12);
			iVar0 = 1;
			break;
		...
		case 35:
			*uParam0 = { -51.23f, 3111.9f, 24.95f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 8);
			iVar0 = 1;
			break;
		...
		case 36:
			*uParam0 = { -55.7984f, -1096.586f, 25.4223f };
			...
			uParam0->f_10 = 126;
			uParam0->f_11 = 126;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 9);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 13);
			iVar0 = 1;
			break;
		...
		case 51:
			*uParam0 = { 68.16914f, -1558.958f, 29.46904f };
			...
			uParam0->f_12 = 2;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 26);
			iVar0 = 1;
			break;
		...
		case 57:
			*uParam0 = { -1598.36f, 5252.84f, 0f };
			...
			uParam0->f_4 = joaat("submersible");
			uParam0->f_13 = 308;
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 2);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 30);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 6);
			iVar0 = 1;
			break;
		...
		case 60:
			*uParam0 = { 1133.21f, 120.2f, 80.9f };
			...
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 13);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 2);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), true);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 23);
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_9), 21);
			iVar0 = 1;
			break;
...
void func_264(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_32751[iParam0]), bParam1);
	}
	else
	{
...
void func_269(int iParam0, var uParam1)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 28);
		}
		if (GET_VEHICLE_NEON_ENABLED(iParam0, 3))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 29);
		}
		if (GET_VEHICLE_NEON_ENABLED(iParam0, 0))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 30);
		}
		if (GET_VEHICLE_NEON_ENABLED(iParam0, 1))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 31);
		}
			...
			if (IS_PLANE_LANDING_GEAR_INTACT(iParam0))
			{
				switch (GET_LANDING_GEAR_STATE(iParam0))
				{
					...
					case 0:
						...
						unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 22);
						break;
					...
					case 5:
						unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 23);
						break;
				}
			}
			else
		...
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 9);
		}
		if (IS_VEHICLE_STOLEN(iParam0))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 10);
		}
		if (GET_IS_VEHICLE_PRIMARY_COLOUR_CUSTOM(iParam0))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 13);
			GET_VEHICLE_CUSTOM_PRIMARY_COLOUR(iParam0, &(uParam1->f_71), &(uParam1->f_72), &(uParam1->f_73));
		}
		if (GET_IS_VEHICLE_SECONDARY_COLOUR_CUSTOM(iParam0))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 12);
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), func_270(iVar0 + 1));
			}
			iVar0++;
		}
		if (unk_0xBCE48C8677F9824(iParam0, 0))
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 11);
		}
		else
		{
		...
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam1->f_77), 27);
		}
		else
		{
...
int func_275(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (GET_PED_PROP_INDEX(iParam0, Global_78341[1 /*14*/].f_12, 1) == Global_78341[1 /*14*/].f_3 && (unk_0xDC23FA727759F9F(iParam0, Global_78341[1 /*14*/].f_12) == Global_78341[1 /*14*/].f_4 || Global_78341[1 /*14*/].f_3 == -1))
		{
			return 1;
		}
	}
	else if (Global_78341[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(iParam0, func_276(iParam1)) && Global_78341[1 /*14*/].f_4 == GET_PED_TEXTURE_VARIATION(iParam0, func_276(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_278(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar3 <= (iVar1 - 1))
	{
		if (iVar3 != iParam1)
		{
			iVar2 = (iVar2 + GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, iVar0, iVar3));
		}
		else
		{
			iVar2 = (iVar2 + iParam2);
...
int func_281(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar2 = SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 1, -1, -1);
		if (iVar2 <= iVar1)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar5 = SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_276(iParam2));
		if (iVar5 <= iVar4)
		{
			return -1;
		}
...
int func_289(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 12)
	{
		iVar2 = SETUP_SHOP_PED_OUTFIT_QUERY(iParam3, 0);
		iVar1 = 0;
		while (iVar1 < iVar2)
		{
	...
	{
		SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 1, -1, -1);
		iVar3 = GET_SHOP_PED_QUERY_PROP_INDEX(iParam1);
		if (iVar3 != -1)
		{
	...
	{
		SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_276(iParam2));
		iVar4 = GET_SHOP_PED_QUERY_COMPONENT_INDEX(iParam1);
		if (iVar4 != -1)
		{
...
void func_293(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	SETUP_SHOP_PED_OUTFIT_QUERY(iVar0, 0);
...
void func_299(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam7)
	{
		unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), 3);
	}
	if (bParam10)
	{
		unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), false);
		if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
		{
			unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), 5);
		}
		unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), true);
		unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), 2);
		unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), 6);
		if (func_24(14))
		{
			return;
		}
		if (iParam1 == 1)
		{
			...
			{
				unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), 7);
			}
		}
		if (iParam1 == 12)
		{
			...
			{
				unk_0xB0C9A0F9AAEB7F0(&(uParam0->f_6), 4);
			}
		}
		else if (iParam1 == 13)
		{
...
int func_302(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 14192)
	{
		...
		if (N_0X767FBC2AC802EF3D(uVar0, &uVar1, -1))
		{
			return uVar1;
		}
	}
...
int func_305(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/][iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/][iParam3]), bParam4);
		}
	...
	else if (iParam0 == 1)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_4[iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_4[iParam3]), bParam4);
		}
	...
	else if (iParam0 == 2)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_8[iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_8[iParam3]), bParam4);
		}
	...
	else if (iParam0 == 3)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_12[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_12[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_16[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_16[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_20[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_20[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_24[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_24[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 4)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_28[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_28[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 5)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_32[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_32[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 6)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_36[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_36[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 7)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_40[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_40[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 8)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_44[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_44[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 9)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_48[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_48[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 4)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_52[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_52[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_56[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_56[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_60[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_60[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_64[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_64[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 5)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_68[iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_68[iParam3]), bParam4);
		}
	...
	else if (iParam0 == 6)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_72[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_72[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_76[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_76[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_80[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_80[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_84[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_84[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 4)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_88[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_88[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 7)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_92[iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_92[iParam3]), bParam4);
		}
	...
	else if (iParam0 == 8)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_96[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_96[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_100[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_100[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_104[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_104[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 9)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_108[iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_108[iParam3]), bParam4);
		}
	...
	else if (iParam0 == 10)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_112[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_112[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_116[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_116[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 11)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_120[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_120[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_124[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_124[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 12)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_128[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_128[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_132[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_132[iParam3]), bParam4);
			}
	...
	else if (iParam0 == 13)
	{
		if (iParam5 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_136[iParam3]), bParam4);
		}
		if (iParam6 == 1)
		{
			CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_136[iParam3]), bParam4);
		}
	...
	else if (iParam0 == 14)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_140[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_140[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_144[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_144[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_148[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_148[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_152[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_152[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 4)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_156[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_156[iParam3]), bParam4);
			}
		...
		else if (iParam2 == 5)
		{
			if (iParam5 == 1)
			{
				unk_0xB0C9A0F9AAEB7F0(&(Global_113648.f_2365[iParam1 /*164*/].f_160[iParam3]), bParam4);
			}
			if (iParam6 == 1)
			{
				CLEAR_BIT(&(Global_113648.f_2365[iParam1 /*164*/].f_160[iParam3]), bParam4);
			}
...
bool func_307(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	*uParam2 = 14192;
	...
	if (bParam4)
	{
		if (Global_4539485)
		{
			iVar0 = GET_FM_MALE_SHOP_PED_APPAREL_ITEM_INDEX(iParam0);
		}
		else
		{
			iVar0 = GET_FM_FEMALE_SHOP_PED_APPAREL_ITEM_INDEX(iParam0);
		}
	}
	else if (bParam5)
	{
...
void func_309(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar3 >= 0)
		{
			iVar4 = SETUP_SHOP_PED_OUTFIT_QUERY(uVar1, 0);
			if (iVar4 > iVar3)
			{
	...
	else if (iParam0 == 14)
	{
		...
		if (iVar7 >= 0)
		{
			iVar8 = SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 1, -1, -1);
			if (iVar8 > iVar7)
			{
				...
				func_299(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_78539)
		{
			...
			func_299(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 != 0);
			return;
		}
		iVar10 = (iParam1 - iParam2);
		if (iVar10 >= 0)
		{
			iVar11 = SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_276(iParam0));
			if (iVar11 > iVar10)
			{
...
void func_366()
{
	...
	{
		DOOR_SYSTEM_SET_DOOR_STATE(iLocal_269, 0, 1, 1);
	}
	else
	{
		DOOR_SYSTEM_SET_DOOR_STATE(iLocal_269, 1, 1, 1);
	}
}
...
void func_367()
{
	if (bLocal_274)
	{
		if (IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || IS_ENTITY_IN_ANGLED_AREA(()(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0))
		{
			if (func_12(&uLocal_150, GET_ENTITY_COORDS(()(), 1)))
			{
	...
	else if (IS_PED_IN_ANY_POLICE_VEHICLE(()()) || iLocal_42 == 1)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(()(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0) || IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_369(Global_41953[13 /*31*/], &fLocal_270);
		}
		else
...
void func_368(int iParam0, float fParam1)
{
	if (IS_DOOR_REGISTERED_WITH_SYSTEM(iParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!N_0X0EAEB0DB4B132399(uLocal_271))
			{
				uLocal_271 = N_0XFCD5C8E06E502F5A(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
			}
			DOOR_SYSTEM_SET_OPEN_RATIO(iParam0, *fParam1, 1, 1);
			*fParam1 = (*fParam1 - (0.2f * timestep()));
			if (*fParam1 <= 0f)
			{
				DOOR_SYSTEM_SET_DOOR_STATE(iParam0, 1, 1, 0);
				N_0X46399A7895957C0E(uLocal_271);
				*fParam1 = 0f;
			}
		}
	}
...
void func_369(int iParam0, float fParam1)
{
	if (*fParam1 != 1f)
	{
		DOOR_SYSTEM_SET_OPEN_RATIO(uParam0, *fParam1, 1, 1);
		*fParam1 = (*fParam1 + (0.2f * timestep()));
		if (N_0X0EAEB0DB4B132399(uLocal_271))
		{
			N_0X46399A7895957C0E(uLocal_271);
...
void func_374()
{
	...
	{
		if (!func_63(()(), 372.0053f, -1604.076f, 36.7536f, 100f, 1) && !bLocal_287)
		{
			func_376("PR_AREAWARN", &bLocal_287);
		}
		else if (!func_63(()(), 372.0053f, -1604.076f, 36.7536f, 170f, 1) && bLocal_287)
		{
			func_375(3);
		}
	}
...
void func_377()
{
	...
	else
	{
		...
		if (iLocal_40 == 2 || iLocal_40 == 3)
		{
			if (!func_153(()(), Local_290.f_0, 50f, 1) && !bLocal_288)
			{
				func_376("PR_VANWARN", &bLocal_288);
			}
			else if (!func_153(()(), Local_290.f_0, 100f, 1) && bLocal_288)
			{
				func_375(4);
			}
		}
...
void func_381(struct<3> Param0, float fParam1, int iParam2, int iParam3)
{
	if (func_382())
	{
		...
		if (iParam2 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_100681.f_20), 14);
		}
		else
		{
		...
		if (iParam3 == 1)
		{
			unk_0xB0C9A0F9AAEB7F0(&(Global_100681.f_20), 24);
		}
		else
		{
...
void func_388()
{
	...
	{
		ADD_DOOR_TO_SYSTEM(iLocal_269, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	DOOR_SYSTEM_SET_DOOR_STATE(Global_41953[13 /*31*/], 1, 1, 0);
	DOOR_SYSTEM_SET_DOOR_STATE(iLocal_269, 1, 1, 0);
}
...
void func_398()
{
	unk_0x6CD913C241C765E("COPS", &uLocal_292);
}

void func_399()
{
	REMOVE_RELATIONSHIP_GROUP(uLocal_292);
	func_410(1);
	if (IS_DOOR_REGISTERED_WITH_SYSTEM(Global_41953[13 /*31*/]))
	{
		N_0X06C0023BED16DD6B(Global_41953[13 /*31*/], 0);
	}
	DOOR_SYSTEM_SET_OPEN_RATIO(Global_41953[13 /*31*/], 0f, 1, 1);
	DOOR_SYSTEM_SET_DOOR_STATE(Global_41953[13 /*31*/], 4, 1, 1);
	DOOR_SYSTEM_SET_DOOR_STATE(iLocal_269, 0, 1, 0);
	REMOVE_DOOR_FROM_SYSTEM(iLocal_269, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_264, 0);
	func_55();
	SET_MAX_WANTED_LEVEL(5);
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_409();
	N_0XA8638BE228D4751A();
	func_400(0);
...
void func_400(bool bParam0)
{
		...
		if (DOES_ENTITY_EXIST(Local_290.f_0))
		{
			if (DOES_ENTITY_EXIST(()()))
			{
				if (!IS_PED_INJURED(()()))
				{
					if (IS_PED_IN_VEHICLE(()(), Local_290.f_0, 0))
					{
						Var0 = { GET_ENTITY_COORDS(()(), 1) };
						SET_ENTITY_COORDS(()(), Var0, 1, 0, 0, 1);
					}
				}
			}
		}
	...
	unk_0xF20DD0DCEB2959F(0);
	if (DOES_CAM_EXIST(uLocal_263))
	{
		RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		DESTROY_CAM(uLocal_263, 0);
	}
}
...
void func_402(var uParam0, bool bParam1)
{
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		...
		{
			ONLY_CLEAN_UP_OBJECT_WHEN_OUT_OF_RANGE(*uParam0);
		}
	}
}
...
void func_408(bool bParam0, int iParam1, int iParam2)
{
	...
	bVar0 = true;
	if (unk_0xCB7695268A7F50F())
	{
		while (bVar0)
		{
			bVar0 = unk_0xCB7695268A7F50F();
			if (N_0XD3C2E180A40F031E())
			{
				N_0XC7272775B4DC786E(0);
			}
			if (unk_0xDDDD9D153BCF51F())
			{
				N_0X440AF51A3462B86F();
			}
			if (unk_0xCB7695268A7F50F() && !N_0XD3C2E180A40F031E())
			{
				bVar0 = false;
			}
			wait(0);
